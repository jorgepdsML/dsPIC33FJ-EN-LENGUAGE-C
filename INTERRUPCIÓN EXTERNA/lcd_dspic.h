#ifndef __lcd_dsPIC_H
#define __lcd_dsPIC_H
//******************************************
//       MANEJO DE PANTALLA LCD16x2          *
//       dsPIC30F,dsPIC33F,PIC32

//******************************************


#define LCD_RD7     PORTBbits.RB3       
#define TRISRD7     TRISBbits.TRISB3

#define LCD_RD6     PORTBbits.RB2       
#define TRISRD6     TRISBbits.TRISB2

#define LCD_RD5     PORTBbits.RB1        
#define TRISRD5     TRISBbits.TRISB1

#define LCD_RD4     PORTBbits.RB0        
...
void Lcd_Init(void);
void Lcd_string(unsigned char y, unsigned char x, const char *buffer);
void Lcd_write(unsigned char y, unsigned char x, char *buffer);
